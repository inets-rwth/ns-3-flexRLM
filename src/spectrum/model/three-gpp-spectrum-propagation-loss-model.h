...
public:
  ...
  Vector GetCurrentUePosition(uint16_t imsi);
  ...
  std::pair<std::pair<double, double>, std::pair<double, double>> GetAodAoaFromCM (Vector enbLoc, uint16_t imsi);
...
private:
  ...
  */
  ...
  void LoadWalkInfo (std::string walkInfoFile, std::string speedFile, uint16_t imsi);
  void LoadLosInfo (std::string los_file, uint16_t imsi);
