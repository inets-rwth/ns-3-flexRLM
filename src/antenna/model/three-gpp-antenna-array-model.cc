...
ThreeGppAntennaArrayModel::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::ThreeGppAntennaArrayModel")
    ...
    .AddAttribute ("IsotropicElements",
               ...
               MakeBooleanChecker ())
    .AddAttribute ("HorizontalBeamStep",
               "Horizontal beam search angle step that is used for beam scan",
                DoubleValue (9.0),
                MakeDoubleAccessor (&ThreeGppAntennaArrayModel::m_horizBeamSearchAngle),
                MakeDoubleChecker<double> (1.0, 90.0))
    .AddAttribute ("VerticalBeamStep",
                "Vertical beam search angle step that is used for beam scan",
                DoubleValue (20.0),
                MakeDoubleAccessor (&ThreeGppAntennaArrayModel::m_vertBeamSearchAngle),
                MakeDoubleChecker<double> (1.0, 90.0))
  ;
  return tid;
}
...
double
ThreeGppAntennaArrayModel::GetGainDb ()
{
  return m_gE;
}

uint16_t
ThreeGppAntennaArrayModel::GetNumOfRowElements (void) const
{
  return m_numRows;
}

uint16_t
ThreeGppAntennaArrayModel::GetNumOfColumnElements (void) const
{
  return m_numColumns;
}
