...
public:
  ...
  virtual void
  DoSetIAStateOfMacSched (bool iaPerformed, uint16_t rnti) override;
...
private:
  ...
  uint8_t PrependCSIRSSym (uint8_t symStart, uint8_t numSymToAllocate,
                          DciInfoElementTdma::DciFormat mode,
                          std::deque<VarTtiAllocInfo> *allocations) const;
