...
public:
  ...
  virtual std::pair<std::pair<bool, bool>, std::pair<uint64_t, uint8_t>> IsCSIRSRequired (const SfnSf &dlSfn) = 0;

  virtual void SetMACCSIRSTimer (bool csiRSTimer) = 0;
};
...
public:
  ...
  /**
   * \brief Notify MAC layer that optimal beam has been found, and RA procedure can be started 
   */
