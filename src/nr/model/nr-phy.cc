...
NrPhy::GetTypeId ()
{
  static TypeId
    ...
    .AddAttribute ("MinCSIRSFromServingGnb",
                   ...
                   UintegerValue (4),
                   MakeUintegerAccessor (&NrPhy::m_minCSIRSFromServingGnb),
    ...
    .AddAttribute ("AntennaConfiguration",
                   ...
                   MakeEnumAccessor (&NrPhy::m_antennaConfig),
...
void
NrPhy::AddSpectrumPropagationLossModel (Ptr<SpectrumPropagationLossModel> model)
{
  m_spectrumPropagationLossModel = model;
}

void
NrPhy::AddPropagationLossModel (Ptr<PropagationLossModel> model)
{
...
void 
NrPhy::SetPHYEpcHelper (Ptr<EpcHelper> epcHelper)
{
...
NrPhy::GetAodAoaFromSM (Vector enbLoc, uint16_t imsi)
{
 return DynamicCast<ThreeGppSpectrumPropagationLossModel>(m_spectrumPropagationLossModel)->GetAodAoaFromCM (enbLoc, imsi);
}
