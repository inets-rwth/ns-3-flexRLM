...
public:
  ...
  std::pair<std::pair<double, double>, std::pair<double, double>> GetAodAoaFromSM (Vector enbLoc, uint16_t imsi);
...
protected:
  ...
  virtual void SetPHYEpcHelper (Ptr<EpcHelper> epcHelper);
...
protected:
  ...
  std::map<SfnSfKey, BeamId> m_sfnBeamIdMap;
