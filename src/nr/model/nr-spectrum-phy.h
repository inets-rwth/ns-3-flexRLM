...
public:
  ...
  enum State
  {
    ...
    RX_DL_SSB  //!< Receiving SSB from a gNB
  };
   ...
   */
  void StartTxDataFrames (const Ptr<PacketBurst>& pb, const std::list<Ptr<NrControlMessage> >& ctrlMsgList, Time duration, uint8_t slotInd, uint64_t imsi);
  /**
