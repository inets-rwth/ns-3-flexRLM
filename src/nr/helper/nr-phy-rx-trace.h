...
public:
  ...
  static void RadioLinkMonitoringTraceCallback (Ptr<NrPhyRxTrace> phyStats, std::string path, RadioLinkMonitoringTraceParams params);
...
static void RxNewTraceUeCallback (Ptr<NrPhyRxTrace> phyStats, std::string path, RxPacketTraceParams param);
...
private:
  ...
  static std::ofstream m_radioLinkMonitoringTraceFile;
  static std::string m_radioLinkMonitoringTraceFilename;
  ...
  static std::map<uint64_t, uint32_t> totalBytesMacRx;

  static std::ofstream m_rxThruFile;
  static std::string m_rxThruFilename;
  static std::map<uint64_t, double> timeLastOutput;
  static std::map<uint64_t, uint32_t> totalBytesReceived;

  static std::map<uint64_t, uint32_t> lastFrameNum;
  static std::map<uint64_t, uint32_t> lastFrameNumMacRx;
