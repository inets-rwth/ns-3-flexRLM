...
public:
  ...
  virtual void StartBeamSweep (NrPhy::BeamSweepType beamSweepType) = 0;

  virtual void SetPhyIAFlag (bool iaAlreadyTrigger) = 0;

  virtual void SetPhyIAState (bool iaState) = 0;

  virtual void CancelPendingReceivePduEvents () = 0;

  virtual double GetLastPerceivedSinr () = 0;

  virtual void ConfigureCSIRSResources (std::pair<uint8_t, uint8_t> startingSubframeSlotPair,
                                        uint8_t csiRSOffset,
                                        uint8_t csiRSPeriodicity,
                                        uint8_t noOfCSIRSResourcesPerSSBurst) = 0;

  virtual void NotifyHandoverSuccessful () = 0;
...
public:
  ...
  /**
   * \brief Nr Version of NotifyOutOfSync
   */
  virtual void NotifyOutOfSyncNr () = 0;
  ...
  /**
   * \brief Forward the optimal gNB beam to gNB
   */
  ...
  virtual void SendUeDeregisterToGnb () = 0;

  virtual bool CheckLteEnbForHandoverEvents (uint64_t imsi) = 0;

  virtual bool IsRrcIdleStart () = 0;

  virtual void ClearHandoverEventsAtCoordinator () = 0;

  virtual void ChangeBeamSweepCompleteAtCoordinator (bool beamSweepComplete) = 0;
...
public:
  ...
  virtual void StartBeamSweep (NrPhy::BeamSweepType beamSweepType);
  virtual void SetPhyIAFlag (bool iaAlreadyTrigger);
  virtual void SetPhyIAState (bool iaState);
  virtual void CancelPendingReceivePduEvents ();
  virtual double GetLastPerceivedSinr ();
  virtual void ConfigureCSIRSResources (std::pair<uint8_t, uint8_t> startingSubframeSlotPair,
                                        uint8_t csiRSOffset,
                                        uint8_t csiRSPeriodicity,
                                        uint8_t noOfCSIRSResourcesPerSSBurst);
  virtual void NotifyHandoverSuccessful ();
...
template <class C>
const Ptr<NetDevice> MemberLteUeCphySapProvider<C>::GetNetDeviceFromPhy ()
{
  return m_owner->DoGetDevice ();
}

template <class C>
void MemberLteUeCphySapProvider<C>::StartBeamSweep (NrPhy::BeamSweepType beamSweepType)
{
  m_owner->DoStartBeamSweep (beamSweepType);
}

template <class C>
void MemberLteUeCphySapProvider<C>::SetPhyIAFlag (bool iaAlreadyTrigger) 
{
  m_owner->DoSetPhyIAFlag (iaAlreadyTrigger);
}

template <class C>
void MemberLteUeCphySapProvider<C>::SetPhyIAState (bool iaState)
{
  m_owner->DoSetInitialIAState (iaState);
}

template <class C>
void MemberLteUeCphySapProvider<C>::CancelPendingReceivePduEvents ()
{
  m_owner->DoCancelPendingReceivePduEvents ();
}

template <class C>
double MemberLteUeCphySapProvider<C>::GetLastPerceivedSinr ()
{
  return m_owner->DoGetLastPerceivedSinr ();
}

template <class C>
void MemberLteUeCphySapProvider<C>::ConfigureCSIRSResources (std::pair<uint8_t, uint8_t> startingSubframeSlotPair,
                                        uint8_t csiRSOffset,
                                        uint8_t csiRSPeriodicity,
                                        uint8_t noOfCSIRSResourcesPerSSBurst)
{
  m_owner->DoConfigureCSIRSResources (startingSubframeSlotPair, csiRSOffset, csiRSPeriodicity, noOfCSIRSResourcesPerSSBurst);
}

template <class C>
void MemberLteUeCphySapProvider<C>::NotifyHandoverSuccessful ()
{
  m_owner->DoNotifyHandoverSuccessful ();
}
...
public:
  ...
  virtual void NotifyOutOfSyncNr ();
  ...
  virtual void SendUeDeregisterToGnb ();
  virtual bool CheckLteEnbForHandoverEvents (uint64_t imsi);
  virtual bool IsRrcIdleStart ();
  virtual void ClearHandoverEventsAtCoordinator ();
  virtual void ChangeBeamSweepCompleteAtCoordinator (bool beamSweepComplete);
...
template <class C>
void 
MemberLteUeCphySapUser<C>::NotifyOutOfSyncNr ()
{
  m_owner->DoNotifyOutOfSyncNr ();
}
...
template <class C>
void 
MemberLteUeCphySapUser<C>::SendOptimalBeamMapToLteCoordinator (std::map<uint8_t, std::vector<std::pair<std::pair<SfnSf, uint16_t>, std::pair<double, BeamId>>>> cellOptimalBeamMap)
{
...
template <class C>
void 
MemberLteUeCphySapUser<C>::SetRrcTempCellID (uint8_t tempCellId)
{
...
template <class C>
void 
MemberLteUeCphySapUser<C>::SendUeDeregisterToGnb ()
{
  m_owner->DoSendUeDeregisterToGnb ();  
}

template <class C>
bool
MemberLteUeCphySapUser<C>::CheckLteEnbForHandoverEvents (uint64_t imsi)
{
...
template <class C>
bool 
MemberLteUeCphySapUser<C>::IsRrcIdleStart ()
{
...
template <class C>
void 
MemberLteUeCphySapUser<C>::ClearHandoverEventsAtCoordinator ()
{
...
template <class C>
void 
MemberLteUeCphySapUser<C>::ChangeBeamSweepCompleteAtCoordinator (bool beamSweepComplete)
{
  m_owner->DoChangeBeamSweepCompleteAtCoordinator (beamSweepComplete);
}

template <class C>
void
MemberLteUeCphySapUser<C>::SendSSBRSReport (std::vector<std::pair<uint8_t, uint16_t>> optimalBeamIndex, std::map<uint8_t, SfnSf> mapOfStartingSfn, uint8_t servingCellId, uint8_t noOfBeamsTbReported)
{
