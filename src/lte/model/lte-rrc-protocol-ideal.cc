...
void 
LteUeRrcProtocolIdeal::DoSendOptimalGnbBeamMap (LteRrcSap::CellOptimalGnbBeamMap msg)
{
  //DOES NOTHING FOR LTERRCPROTOCOLIDEAL
}

void
LteUeRrcProtocolIdeal::DoTriggerRegisterUe (uint64_t imsi, const Ptr<NetDevice> &netDev)
{
  //DOES NOTHING FOR LTERRCPROTOCOLIDEAL
}

void 
LteUeRrcProtocolIdeal::DoSendDeregisterUe (uint64_t imsi)
{
  //DOES NOTHING FOR LTERRCPROTOCOLIDEAL
}

bool
LteUeRrcProtocolIdeal::DoSendCheckForHandoverEvents (uint64_t imsi)
{
  //DOES NOTHING FOR LTERRCPROTOCOLIDEAL
}

void 
LteUeRrcProtocolIdeal::DoSendClearHandoverEvents (uint64_t imsi)
{
  //DOES NOTHING FOR LTERRCPROTOCOLIDEAL
}

void 
LteUeRrcProtocolIdeal::SetLteEnbRrcSapProvider ()
{
  //DOES NOTHING FOR LteUeRrcProtocolIdeal, SHOULD NOT BE CONFUSED WITH LteGnbRrcProtocolIdeal
}

void 
LteUeRrcProtocolIdeal::DoSendBeamPerformComplete (uint64_t imsi, bool beamSweepComplete)
{
  //DOES NOTHING FOR LteUeRrcProtocolIdeal, SHOULD NOT BE CONFUSED WITH LteGnbRrcProtocolIdeal
}

void 
LteUeRrcProtocolIdeal::DoSendSSBRSReport (LteRrcSap::UpdateBeamsTbRLM params)
{
...
void
LteEnbRrcProtocolIdeal::DoSendBeamSweepTriggerFromLTECoordinator (uint16_t rnti)
{
  // DOES NOTHING FOR LTEENBRRCPROTOCOLIDEAL
}

void 
LteEnbRrcProtocolIdeal::DoSendBeamSweepCommandFromLTECoordinator (uint16_t rnti)
{
  // DOES NOTHING FOR LTEENBRRCPROTOCOLIDEAL
}

void
LteEnbRrcProtocolIdeal::DoSendUeDeRegistrationCompletedUpdate (uint16_t rnti, uint64_t imsi)
{
  // DOES NOTHING FOR LTEENBRRCPROTOCOLIDEAL
}
