...
public:
  ...
  struct UeImsiCSIRSSinrParams
  {
    uint64_t ueImsi;
    uint16_t sourceCellId;
    uint16_t targetCellId;
    std::vector<double> csiRSVector;
    std::vector<uint8_t> csiRSCellIdVector;
    std::vector<BeamId> csiRSBeamIdVector;
  };
  ...
  struct InformLteCoordinatorParams
  {
    uint16_t sourceCellId;
    uint16_t targetCellId;
    uint64_t ueImsi; 
    uint16_t ueRnti;
    bool hoCompletedFlag;
  };
  ...
  struct SuboptimalCSIRSReportParams
  {
    uint64_t imsi;
    uint8_t targetCellId;
    uint16_t sector;
...
public:
  ...
  virtual void SendCoordinatorHandoverRequest (SecondaryHandoverParams params) = 0;

  virtual void InformLteCoordinator (InformLteCoordinatorParams params) = 0;

  virtual void SendSpecificGnbOptimalBeamReport (EpcX2Sap::OptimalGnbBeamReportParams params) = 0;

  virtual void SendDeRegisterUeCommand (EpcX2Sap::DeRegisterUeParams params) = 0;

  virtual void SendDeRegisterUeCompletedUpdate (EpcX2Sap::InformLteCoordinatorParams params) = 0;

  virtual void SendUeCSIRSSinrReport (EpcX2Sap::UeImsiCSIRSSinrParams params) = 0;

  virtual void SendUeSSBRSReport (LteRrcSap::UpdateBeamsTbRLM params) = 0;

  virtual void SendSuboptimalCSIRSReport (EpcX2Sap::SuboptimalCSIRSReportParams params) = 0;

  virtual void SendSetCSIRSFlag (SetCSIRSFlagParams params) = 0;
};
...
public:
  ...
  virtual void RecvCoordinatorHandoverRequest (SecondaryHandoverParams params) = 0;

  virtual void RecvInformLteCoordinator (InformLteCoordinatorParams params) = 0;

  virtual void RecvOptimalGnbBeamReport (LteRrcSap::OptimalGnbBeamReport params) = 0;

  virtual void RecvDeRegisterFromUe (LteRrcSap::DeRegisterUeContext params) = 0;

  virtual void RecvUeDeRegisterCompletedFromGnb (InformLteCoordinatorParams params) = 0;

  virtual void RecvRRCCSIRSReport (uint64_t imsi, uint16_t cellId, std::vector<double> csiRSVector, std::vector<uint8_t> csiRSCellIdVector, std::vector<BeamId> csiRSBeamIdVector) = 0;

  virtual void RecvUpdateBeamsTBRLMFromLteCo (LteRrcSap::UpdateBeamsTbRLM params) = 0;
  
  virtual void RecvSuboptimalCSIRSReport (LteRrcSap::SuboptimalCSIRSReport params) = 0;

  virtual void RecvSetCSIRSFlag (LteRrcSap::SetCSIRSFlagRRC params) = 0;
};
...
public:
  ...
  virtual void SendCoordinatorHandoverRequest (SecondaryHandoverParams params);

  virtual void InformLteCoordinator (InformLteCoordinatorParams params);

  virtual void SendSpecificGnbOptimalBeamReport (EpcX2Sap::OptimalGnbBeamReportParams params);

  virtual void SendDeRegisterUeCommand (EpcX2Sap::DeRegisterUeParams params);

  virtual void SendDeRegisterUeCompletedUpdate (EpcX2Sap::InformLteCoordinatorParams params);

  virtual void SendUeCSIRSSinrReport (EpcX2Sap::UeImsiCSIRSSinrParams params);

  virtual void SendUeSSBRSReport (LteRrcSap::UpdateBeamsTbRLM params);

  virtual void SendSuboptimalCSIRSReport (EpcX2Sap::SuboptimalCSIRSReportParams params);

  virtual void SendSetCSIRSFlag (SetCSIRSFlagParams params);
...
template <class C>
void
EpcX2SpecificEpcX2SapProvider<C>::SendCoordinatorHandoverRequest (SecondaryHandoverParams params)
{
  m_x2->DoSendCoordinatorHandoverRequest (params);
}

template <class C>
void
EpcX2SpecificEpcX2SapProvider<C>::InformLteCoordinator (InformLteCoordinatorParams params)
{
  m_x2->DoInformLteCoordinator (params);
}

template <class C>
void 
EpcX2SpecificEpcX2SapProvider<C>::SendSpecificGnbOptimalBeamReport (EpcX2Sap::OptimalGnbBeamReportParams params)
{
...
template <class C>
void 
EpcX2SpecificEpcX2SapProvider<C>::SendDeRegisterUeCommand (EpcX2Sap::DeRegisterUeParams params)
{
...
template <class C>
void 
EpcX2SpecificEpcX2SapProvider<C>::SendDeRegisterUeCompletedUpdate (EpcX2Sap::InformLteCoordinatorParams params)
{
  m_x2->DoSendDeRegisterCompletedToUe (params);
}

template <class C>
void 
EpcX2SpecificEpcX2SapProvider<C>::SendUeCSIRSSinrReport (EpcX2Sap::UeImsiCSIRSSinrParams params)
{
  m_x2->DoSendUeCSIRSSinrReport (params);
}

template <class C>
void 
EpcX2SpecificEpcX2SapProvider<C>::SendUeSSBRSReport (LteRrcSap::UpdateBeamsTbRLM params)
{
...
template <class C>
void 
EpcX2SpecificEpcX2SapProvider<C>::SendSuboptimalCSIRSReport (EpcX2Sap::SuboptimalCSIRSReportParams params)
{
  m_x2->DoSendSuboptimalCSIRSReport (params);
}

template <class C>
void
EpcX2SpecificEpcX2SapProvider<C>::SendSetCSIRSFlag (SetCSIRSFlagParams params)
{
  m_x2->DoSendSetCSIRSFlag (params);
}
...
public:
  ...
  virtual void RecvCoordinatorHandoverRequest (SecondaryHandoverParams params);

  virtual void RecvInformLteCoordinator (InformLteCoordinatorParams params);

  virtual void RecvOptimalGnbBeamReport (LteRrcSap::OptimalGnbBeamReport params);

  virtual void RecvDeRegisterFromUe (LteRrcSap::DeRegisterUeContext params);

  virtual void RecvUeDeRegisterCompletedFromGnb (InformLteCoordinatorParams params);

  virtual void RecvRRCCSIRSReport (uint64_t imsi, uint16_t cellId, std::vector<double> csiRSVector, std::vector<uint8_t> csiRSCellIdVector, std::vector<BeamId> csiRSBeamIdVector);

  virtual void RecvUpdateBeamsTBRLMFromLteCo (LteRrcSap::UpdateBeamsTbRLM params);

  virtual void RecvSuboptimalCSIRSReport (LteRrcSap::SuboptimalCSIRSReport params);

  virtual void RecvSetCSIRSFlag (LteRrcSap::SetCSIRSFlagRRC params);
...
template <class C>
void 
EpcX2SpecificEpcX2SapUser<C>::RecvRRCCSIRSReport (uint64_t imsi, uint16_t cellId, std::vector<double> csiRSVector, std::vector<uint8_t> csiRSCellIdVector, std::vector<BeamId> csiRSBeamIdVector)
{
  m_rrc->DoRecvRRCCSIRSReport (imsi, cellId, csiRSVector, csiRSCellIdVector, csiRSBeamIdVector);
}

template <class C>
void
EpcX2SpecificEpcX2SapUser<C>::RecvCoordinatorHandoverRequest (SecondaryHandoverParams params)
{
  m_rrc->DoRecvCoordinatorHandoverRequest (params);
}

template <class C>
void
EpcX2SpecificEpcX2SapUser<C>::RecvInformLteCoordinator (InformLteCoordinatorParams params)
{
  m_rrc->DoRecvInformLteCoordinator (params);
}

template <class C>
void 
EpcX2SpecificEpcX2SapUser<C>::RecvOptimalGnbBeamReport (LteRrcSap::OptimalGnbBeamReport params)
{
...
template <class C>
void 
EpcX2SpecificEpcX2SapUser<C>::RecvDeRegisterFromUe (LteRrcSap::DeRegisterUeContext params)
{
  m_rrc->DoRecvDeregisterUe (params);
}

template <class C>
void 
EpcX2SpecificEpcX2SapUser<C>::RecvUeDeRegisterCompletedFromGnb (InformLteCoordinatorParams params)
{
  m_rrc->DoRecvUeDeRegisterCompletedFromGnb (params);
}

template <class C>
void 
EpcX2SpecificEpcX2SapUser<C>::RecvUpdateBeamsTBRLMFromLteCo (LteRrcSap::UpdateBeamsTbRLM params)
{
  m_rrc->DoRecvUpdateBeamsTBRLMFromLteCo (params);
}

template <class C>
void 
EpcX2SpecificEpcX2SapUser<C>::RecvSuboptimalCSIRSReport (LteRrcSap::SuboptimalCSIRSReport params)
{
  m_rrc->DoRecvSuboptimalCSIRSReport (params);
}

template <class C>
void 
EpcX2SpecificEpcX2SapUser<C>::RecvSetCSIRSFlag (LteRrcSap::SetCSIRSFlagRRC params)
{
  m_rrc->DoRecvSetCSIRSFlag (params);
}
