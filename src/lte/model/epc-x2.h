...
protected:
  ...
  virtual void DoSendCoordinatorHandoverRequest (EpcX2SapProvider::SecondaryHandoverParams params);

  virtual void DoInformLteCoordinator(EpcX2Sap::InformLteCoordinatorParams params);

  virtual void DoSendSpecificGnbBeamReport (EpcX2Sap::OptimalGnbBeamReportParams params);

  virtual void DoSendDeRegisterUeToCell (EpcX2Sap::DeRegisterUeParams params);

  virtual void DoSendDeRegisterCompletedToUe (EpcX2Sap::InformLteCoordinatorParams params);

  virtual void DoSendUeCSIRSSinrReport (EpcX2Sap::UeImsiCSIRSSinrParams params);

  virtual void DoSendUeSSBRSReport (LteRrcSap::UpdateBeamsTbRLM params);

  virtual void DoSendSuboptimalCSIRSReport (EpcX2Sap::SuboptimalCSIRSReportParams params);

  virtual void DoSendSetCSIRSFlag (EpcX2Sap::SetCSIRSFlagParams params);
