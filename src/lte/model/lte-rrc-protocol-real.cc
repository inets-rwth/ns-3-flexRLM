...
void 
LteUeRrcProtocolReal::DoSendOptimalGnbBeamMap (LteRrcSap::CellOptimalGnbBeamMap msg)
{
  //DOES NOTHING FOR LTERRCPROTOCOLREAL
}

void
LteUeRrcProtocolReal::DoTriggerRegisterUe (uint64_t imsi, const Ptr<NetDevice> &netDev)
{
  //DOES NOTHING FOR LTERRCPROTOCOLREAL
}

void 
LteUeRrcProtocolReal::DoSendDeregisterUe (uint64_t imsi)
{
  //DOES NOTHING FOR LTERRCPROTOCOLREAL
}

bool
LteUeRrcProtocolReal::DoSendCheckForHandoverEvents (uint64_t imsi)
{
  //DOES NOTHING FOR LTERRCPROTOCOLREAL
}

void
LteUeRrcProtocolReal::DoSendClearHandoverEvents (uint64_t imsi)
{
  //DOES NOTHING FOR LTERRCPROTOCOLREAL
}

void 
LteUeRrcProtocolReal::SetLteEnbRrcSapProvider ()
{
  //DOES NOTHING FOR LteUeRrcProtocolReal, SHOULD NOT BE CONFUSED WITH LteGnbRrcProtocolReal
}

void 
LteUeRrcProtocolReal::DoSendBeamPerformComplete (uint64_t imsi, bool beamSweepComplete)
{
  //DOES NOTHING FOR LteUeRrcProtocolReal, SHOULD NOT BE CONFUSED WITH LteGnbRrcProtocolReal
}

void 
LteUeRrcProtocolReal::DoSendSSBRSReport (LteRrcSap::UpdateBeamsTbRLM params)
{
...
void
LteEnbRrcProtocolReal::DoSendBeamSweepTriggerFromLTECoordinator (uint16_t rnti)
{
  Simulator::Schedule (RRC_REAL_MSG_DELAY,
                       &LteUeRrcSapProvider::RecvBeamSweepTriggerFromLTECoordinator,
                       GetUeRrcSapProvider (rnti));
}

void 
LteEnbRrcProtocolReal::DoSendBeamSweepCommandFromLTECoordinator (uint16_t rnti)
{
  Simulator::Schedule (RRC_REAL_MSG_DELAY,
                       &LteUeRrcSapProvider::RecvBeamSweepCommandFromLTECoordinator,
                       GetUeRrcSapProvider (rnti));
}

void
LteEnbRrcProtocolReal::DoSendUeDeRegistrationCompletedUpdate (uint16_t rnti, uint64_t imsi)
{
  Simulator::Schedule (RRC_REAL_MSG_DELAY,
                       &LteUeRrcSapProvider::RecvUeDeRegistrationCompletedUpdate,
                       GetUeRrcSapProvider (rnti),
                       imsi);
}
