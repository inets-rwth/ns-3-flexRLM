...
public:
  ...
  struct CSIConfigParameters
  {
    uint16_t csiRSOfset;
    uint16_t ciRSPeriodicity;
    uint16_t noOfCSIRSResourcesPerSSBurst;
    std::pair<uint8_t, uint8_t> initialCSIRSResource;
  };
  ...
  struct RadioResourceConfigDedicated
  {
    ...
    CSIConfigParameters csiConfigParams;
  };
  ...
  struct RrcConnectionRequest
  {
    ...
    Ptr<NetDevice> netDev;    ///<NetDevice of the UE
  };
  ...
  {
    uint8_t rrcTransactionIdentifier; ///< RRC transaction identifier
    uint64_t imsi;                    ///< Imsi of the UE, to be used to register it 
  };
  ...
  // OptimalGnbBeamReport structure
  ...
  // SuboptimalCSIRSReport structure
  struct SuboptimalCSIRSReport
  {
    uint64_t ueImsi;
    uint16_t sector;
    double elevation;
...
public:
  ...
  struct SetupParameters
  {
    ...
    bool firstConnToNetwork;            ///< indicates whether it is the first time that UE is joining the network
  };
  ...
  /**
   * \brief Trigger RegisterUe at nr-gnb-phy from UE side
   * 
   * \param imsi imsi of the UE
   * \param netDev pointer to UE device, which will later be used by nr-gnb-phy
   */
   virtual void TriggerRegisterUE (uint64_t imsi, Ptr<NetDevice> netDev) = 0;

  /**
   * \brief Send DeregisterUe from UE to GNB (assumed to be done over LTE coordinator)
   */
   virtual void SendDeregisterUe (uint64_t imsi) = 0;

   virtual bool SendCheckForHandoverEvents (uint64_t imsi) = 0;

   virtual void DoSetLteEnbRrcSapProviderFromHelper () = 0;

   virtual void SendClearHandoverEvents (uint64_t imsi) = 0;

   virtual void SendBeamPerformComplete (uint64_t imsi, bool beamSweepComplete) = 0;
...
public:
  ...
  virtual void RecvBeamSweepTriggerFromLTECoordinator () = 0;

  virtual void RecvBeamSweepCommandFromLTECoordinator () = 0;

  virtual void RecvUeDeRegistrationCompletedUpdate (uint64_t imsi) = 0;
...
public:
  ...
  virtual void SendBeamSweepTriggerFromLTECoordinator (uint16_t rnti) = 0;

  virtual void SendBeamSweepCommandFromLTECoordinator (uint16_t rnti) = 0;

  virtual void SendUeDeRegistrationCompletedUpdate (uint16_t rnti, uint64_t imsi) = 0;
...
public:
  ...
  virtual void RecvDeregisterUe (DeRegisterUeContext params) = 0;

  virtual bool CheckForHandoverEvents (uint64_t imsi) = 0;

  virtual void RecvDeRegisterUeCommand (DeRegisterUeContext msg) = 0;

  virtual void RecvClearHandoverEvents (uint64_t imsi) = 0;

  virtual void RecvBeamPerformComplete (uint64_t imsi, bool beamSweepComplete) = 0;
...
public:
  ...
  virtual void SendDeregisterUe (uint64_t imsi);
  virtual bool SendCheckForHandoverEvents (uint64_t imsi);
  virtual void DoSetLteEnbRrcSapProviderFromHelper ();
  virtual void SendClearHandoverEvents (uint64_t imsi);
  virtual void SendBeamPerformComplete (uint64_t imsi, bool beamSweepComplete);
...
template <class C>
void 
MemberLteUeRrcSapUser<C>::SendOptimalGnbBeamMap (CellOptimalGnbBeamMap msg)
{
...
template <class C>
void 
MemberLteUeRrcSapUser<C>::TriggerRegisterUE (uint64_t imsi, Ptr<NetDevice> netDev)
{
...
template <class C>
void 
MemberLteUeRrcSapUser<C>::SendDeregisterUe (uint64_t imsi)
{
  m_owner->DoSendDeregisterUe (imsi);
}

template <class C>
bool 
MemberLteUeRrcSapUser<C>::SendCheckForHandoverEvents (uint64_t imsi)
{
  return m_owner->DoSendCheckForHandoverEvents (imsi);
}

template <class C>
void 
MemberLteUeRrcSapUser<C>::DoSetLteEnbRrcSapProviderFromHelper ()
{
  m_owner->SetLteEnbRrcSapProvider ();
}

template <class C>
void
MemberLteUeRrcSapUser<C>::SendClearHandoverEvents (uint64_t imsi)
{
...
template <class C>
void
MemberLteUeRrcSapUser<C>::SendBeamPerformComplete (uint64_t imsi, bool beamSweepComplete)
{
  m_owner->DoSendBeamPerformComplete (imsi, beamSweepComplete);
}

template <class C>
void 
MemberLteUeRrcSapUser<C>::SendSSBRSReport (UpdateBeamsTbRLM params)
{
...
public:
  ...
  virtual void RecvBeamSweepTriggerFromLTECoordinator ();
  virtual void RecvBeamSweepCommandFromLTECoordinator ();
  virtual void RecvUeDeRegistrationCompletedUpdate (uint64_t imsi);
...
template <class C>
void 
MemberLteUeRrcSapProvider<C>::RecvBeamSweepTriggerFromLTECoordinator ()
{
  Simulator::ScheduleNow (&C::DoRecvBeamSweepTriggerFromLTECoordinator, m_owner);
}

template <class C>
void
MemberLteUeRrcSapProvider<C>::RecvBeamSweepCommandFromLTECoordinator ()
{
  Simulator::ScheduleNow (&C::DoRecvBeamSweepCommandFromLTECoordinator, m_owner);
}

template <class C>
void 
MemberLteUeRrcSapProvider<C>::RecvUeDeRegistrationCompletedUpdate (uint64_t imsi)
{
  Simulator::ScheduleNow (&C::DoRecvUeDeRegistrationUpdate, m_owner, imsi);
}
...
public:
  ...
  virtual void SendBeamSweepTriggerFromLTECoordinator (uint16_t rnti);
  virtual void SendBeamSweepCommandFromLTECoordinator (uint16_t rnti);
  virtual void SendUeDeRegistrationCompletedUpdate (uint16_t rnti, uint64_t imsi);
...
template <class C>
void 
MemberLteEnbRrcSapUser<C>::SendBeamSweepTriggerFromLTECoordinator (uint16_t rnti)
{
  m_owner->DoSendBeamSweepTriggerFromLTECoordinator (rnti);
}

template <class C>
void 
MemberLteEnbRrcSapUser<C>::SendBeamSweepCommandFromLTECoordinator (uint16_t rnti)
{
  m_owner->DoSendBeamSweepCommandFromLTECoordinator (rnti);
}

template <class C>
void 
MemberLteEnbRrcSapUser<C>::SendUeDeRegistrationCompletedUpdate (uint16_t rnti, uint64_t imsi)
{
  m_owner->DoSendUeDeRegistrationCompletedUpdate (rnti, imsi);
}
...
public:
  ...
  virtual void RecvDeregisterUe (DeRegisterUeContext params);
  virtual bool CheckForHandoverEvents (uint64_t imsi);
  virtual void RecvDeRegisterUeCommand (DeRegisterUeContext msg);
  virtual void RecvClearHandoverEvents (uint64_t imsi);
  virtual void RecvBeamPerformComplete (uint64_t imsi, bool beamSweepComplete);
...
template <class C>
void MemberLteEnbRrcSapProvider<C>::RecvOptimalGnbBeamMap (CellOptimalGnbBeamMap msg)
{
  Simulator::ScheduleNow (&C::DoRecvOptimalGnbBeamMap, m_owner, msg);
}

template <class C>
void MemberLteEnbRrcSapProvider<C>::RecvTriggerRegisterUe (uint64_t imsi, const Ptr<NetDevice> &netDev)
{
  m_owner->DoRecvTriggerRegisterUe (imsi, netDev);
}

template <class C>
void MemberLteEnbRrcSapProvider<C>::RecvRegisterUeFromRRC (uint64_t imsi)
{
  m_owner->DoRecvRegisterUE (imsi);
}

template <class C>
void MemberLteEnbRrcSapProvider<C>::RecvDeregisterUe (DeRegisterUeContext params)
{
  m_owner->DoRecvDeregisterUe (params);
}

template <class C>
bool MemberLteEnbRrcSapProvider<C>::CheckForHandoverEvents (uint64_t imsi)
{
  return m_owner->DoCheckForHandoverEvents (imsi);
}

template <class C>
void MemberLteEnbRrcSapProvider<C>::RecvDeRegisterUeCommand (DeRegisterUeContext msg) //THIS WILL BE RECEIVED BY LTE COORDINATOR
{
  m_owner->DoRecvDeRegisterUeCommand (msg);
}

template <class C>
void MemberLteEnbRrcSapProvider<C>::RecvClearHandoverEvents (uint64_t imsi)
{
  m_owner->DoRecvClearHandoverEvent (imsi);
}

template <class C>
void MemberLteEnbRrcSapProvider<C>::RecvBeamPerformComplete (uint64_t imsi, bool beamSweepComplete)
{
  m_owner->DoRecvBeamPerformComplete (imsi, beamSweepComplete);
}

template <class C>
void MemberLteEnbRrcSapProvider<C>::ForwardSSBRSBeamReport (UpdateBeamsTbRLM params)
{
